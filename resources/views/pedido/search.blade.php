...
<div class="mb-8">
    <form method="GET" action="{{ route('pedido.menu.search') }}" class="flex gap-2">
        <input type="text" name="q" value="{{ $query }}" placeholder="Buscar produtos..." class="flex-1 border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500">
...
<div class="text-center py-12">
    ...
    <a href="{{ route('pedido.index') }}" class="inline-block text-orange-500 hover:text-orange-600">Voltar ao cardápio</a>
</div>
@endif
@endsection
