        ...
        <div class="p-6">
            <form id="printer-type-form" method="POST" action="{{ route('dashboard.settings.printing.update') }}">
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    ...
                    <div class="printer-type-card {{ ($printingSettings->printer_type ?? 'thermal') === 'thermal' ? 'selected' : '' }}" data-type="thermal">
                        <input type="radio" name="printer_type" value="thermal" id="thermal" 
                               {{ ($printingSettings->printer_type ?? 'thermal') === 'thermal' ? 'checked' : '' }} class="hidden">
                    ...
                    <!-- Impressora Comum A4 -->
                    <div class="printer-type-card {{ ($printingSettings->printer_type ?? 'thermal') === 'regular' ? 'selected' : '' }}" data-type="regular">
                        <input type="radio" name="printer_type" value="regular" id="regular" 
                               {{ ($printingSettings->printer_type ?? 'thermal') === 'regular' ? 'checked' : '' }} class="hidden">
                ...
                <div id="regular-settings" class="mt-6 p-6 bg-muted/30 rounded-xl {{ ($printingSettings->printer_type ?? 'thermal') !== 'regular' ? 'hidden' : '' }}">
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        <div>
                            ...
                            <select name="receipt_size" class="w-full px-3 py-2 border border-border rounded-lg bg-background">
                                <option value="half-page" {{ ($printingSettings->receipt_size ?? 'half-page') === 'half-page' ? 'selected' : '' }}>Meia Página A4 (14,8 x 21cm)</option>
                                <option value="quarter-page" {{ ($printingSettings->receipt_size ?? 'half-page') === 'quarter-page' ? 'selected' : '' }}>1/4 de Página A4 (10,5 x 14,8cm)</option>
                                <option value="80mm" {{ ($printingSettings->receipt_size ?? 'half-page') === '80mm' ? 'selected' : '' }}>80mm de largura</option>
                                <option value="full-page" {{ ($printingSettings->receipt_size ?? 'half-page') === 'full-page' ? 'selected' : '' }}>Página Inteira A4</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" name="default_copies" min="1" max="5" 
                                   value="{{ $printingSettings->default_copies ?? 1 }}"
                        ...
                        <div>
                            ...
                            <select name="page_orientation" class="w-full px-3 py-2 border border-border rounded-lg bg-background">
                                <option value="portrait" {{ ($printingSettings->page_orientation ?? 'portrait') === 'portrait' ? 'selected' : '' }}>Retrato (vertical)</option>
                                <option value="landscape" {{ ($printingSettings->page_orientation ?? 'portrait') === 'landscape' ? 'selected' : '' }}>Paisagem (horizontal)</option>
                            </select>
                        ...
                        <div>
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="show_logo" value="1" 
                                       {{ ($printingSettings->show_logo ?? false) ? 'checked' : '' }}
                        ...
                        <div>
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="show_qrcode" value="1" 
                                       {{ ($printingSettings->show_qrcode ?? false) ? 'checked' : '' }}
                                       class="rounded border-border">
