...
@section('content')
    ...
    <header class="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
        <div class="container mx-auto px-4 py-4">
            <a href="{{ route('pedido.cart.index') }}"
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-5xl mx-auto">
            ...
            <form id="checkoutForm" method="POST" action="{{ route('pedido.checkout.store') }}">
                ...
                <input type="hidden" name="delivery_fee" id="hidden_delivery_fee"
                    value="{{ $initialDeliveryFee !== null ? number_format($initialDeliveryFee, 2, '.', '') : 0 }}">
                <input type="hidden" name="base_delivery_fee" id="hidden_base_delivery_fee"
                    value="{{ $initialBaseDeliveryFee !== null ? number_format($initialBaseDeliveryFee, 2, '.', '') : 0 }}">
                <input type="hidden" name="delivery_discount_percent" id="hidden_delivery_discount_percent"
                    value="{{ number_format($initialDeliveryDiscountPercent, 2, '.', '') }}">
                <input type="hidden" name="delivery_discount_amount" id="hidden_delivery_discount_amount"
                    value="{{ number_format($initialDeliveryDiscountAmount, 2, '.', '') }}">
                <input type="hidden" name="delivery_fee_locked" id="hidden_delivery_fee_locked"
                    value="{{ $initialFreteCalculado ? 1 : 0 }}">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="p-6 pt-0 space-y-4">
                                <div>
                                    <label
                                        ...
                                        for="customer_name">Nome completo *</label>
                                ...
                                <div>
                                    <label
                                        class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                                        for="customer_phone">Telefone *</label>
                        ...
                        <div id="addressCard" class="rounded-lg border bg-card text-card-foreground shadow-sm shadow-warm">
                            ...
                            <div class="p-6 pt-0 space-y-4">
                                ...
                                <div>
                                    <label
                                        class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                                        for="zip_code">CEP *</label>
                                    <div class="flex gap-2">
                                        <input type="text" name="zip_code" id="zip_code"
                                            value="{{ old('zip_code', $prefill['zip_code'] ?? '') }}" required maxlength="9"
                                            pattern="[0-9]{5}-?[0-9]{3}"
                                            class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm"
                                            placeholder="00000-000">
                                        <button type="button" id="zip_code_manual_button"
                                            class="hidden px-4 py-2 rounded-md border border-input bg-background text-sm font-medium hover:bg-accent hover:text-accent-foreground transition-colors">
                                ...
                                <div>
                                    <label
                                        class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                                        for="address">Rua/Logradouro *</label>
                                    <input type="text" name="street" id="address"
                                        value="{{ old('street', $prefill['address'] ?? $prefill['street'] ?? '') }}"
                                        required
                                        class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm"
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="number" id="number"
                                            value="{{ old('number', $prefill['number'] ?? '') }}" required
                                            class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm"
                                            placeholder="123">
                                    </div>
                                    <div>
                                        ...
                                        <input type="text" name="complement" id="complement"
                                            value="{{ old('complement', $prefill['complement'] ?? '') }}"
                                            class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="neighborhood" id="neighborhood"
                                        value="{{ old('neighborhood', $prefill['neighborhood'] ?? '') }}" required
                                        class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm"
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="state" id="state"
                                            value="{{ old('state', $prefill['state'] ?? '') }}" required maxlength="2"
                            ...
                            <div class="p-6 pt-0">
                                <div>
                                    <label
                                        ...
                                        for="orderNotes">Observações gerais (opcional)</label>
                                    <textarea name="notes" id="orderNotes" rows="4" maxlength="1000"
                                        class="flex min-h-[80px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 resize-none"
                                        placeholder="Ex: Deixar na portaria, entregar para fulano, etc.">{{ old('notes', '') }}</textarea>
                        ...
                        <div class="rounded-lg border bg-card text-card-foreground shadow-sm shadow-warm">
                            ...
                            <div class="p-6 pt-0 space-y-4">
                                ...
                                <div class="flex gap-3">
                                    <input type="text" name="coupon_code" id="coupon_code_private"
                                        placeholder="Digite o código do cupom"
                                        class="flex-1 flex h-10 rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm {{ isset($appliedCouponCode) && $appliedCouponCode ? 'bg-muted cursor-not-allowed' : '' }}"
                                        value="{{ old('coupon_code', isset($appliedCouponCode) ? $appliedCouponCode : '') }}"
                                        {{ isset($appliedCouponCode) && $appliedCouponCode ? 'readonly' : '' }}>
                                    <button type="button" id="applyCouponBtn"
                                        class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 {{ isset($appliedCouponCode) && $appliedCouponCode ? 'opacity-50 cursor-not-allowed' : '' }}"
                                        {{ isset($appliedCouponCode) && $appliedCouponCode ? 'disabled' : '' }}>
                                        {{ isset($appliedCouponCode) && $appliedCouponCode ? 'Aplicado' : 'Aplicar' }}
                                    </button>
                                </div>
                                @if(isset($appliedCouponCode) && $appliedCouponCode)
                                    <p id="couponFeedback" class="text-sm text-green-600 font-medium">✓ Cupom
                                        {{ $appliedCouponCode }} aplicado</p>
                                @else
                                ...
                                <input type="hidden" name="applied_coupon_code" id="applied_coupon_code"
                                    value="{{ isset($appliedCouponCode) ? $appliedCouponCode : '' }}">
                            </div>
                        </div>
                        ...
                        <div class="rounded-lg border bg-card text-card-foreground shadow-sm shadow-warm">
                            ...
                            <div class="p-6 pt-0 space-y-4">
                                <div>
                                    <label
                                        class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 mb-2 block">Data
                                        *</label>
                                    <select name="scheduled_delivery_date" id="scheduled_delivery_date" required
                                        class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm">
                                        <option value="">Selecione uma data</option>
                                        @foreach($availableDates ?? [] as $date)
                                            <option value="{{ $date['date'] }}" data-day="{{ $date['day_name'] }}">
                                                {{ $date['day_name'] }}, {{ $date['label'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div>
                                    <label
                                        class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 mb-2 block">Horário
                                        *</label>
                                    <select name="scheduled_delivery_slot" id="scheduled_delivery_slot" required
                                        class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm disabled:bg-muted"
                                        disabled>
                                        <option value="">Selecione primeiro uma data</option>
                                    </select>
                                    <p id="slotError" class="text-xs text-destructive mt-1 hidden">Por favor, selecione um
                                        horário de entrega</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="rounded-lg border bg-card text-card-foreground shadow-sm shadow-warm">
                            ...
                            <div class="p-6 pt-0">
                                <div role="radiogroup" class="grid gap-2">
                                    <div
                                        class="flex items-center space-x-3 p-4 border border-border rounded-lg hover:bg-secondary/50 transition-smooth {{ !isset($order) || ($order->payment_method ?? 'pix') === 'pix' ? 'border-primary bg-primary/5' : '' }}">
                                        <input type="radio" name="payment_method" value="pix" id="payment_pix"
                                            ...
                                            {{ !isset($order) || ($order->payment_method ?? 'pix') === 'pix' ? 'checked' : '' }} required>
                                    ...
                                    <div
                                        class="flex items-center space-x-3 p-4 border border-border rounded-lg hover:bg-secondary/50 transition-smooth {{ isset($order) && ($order->payment_method ?? '') === 'mercadopago' ? 'border-primary bg-primary/5' : '' }}">
                                        <input type="radio" name="payment_method" value="mercadopago"
                                            id="payment_mercadopago"
                                            class="aspect-square h-4 w-4 rounded-full border border-primary text-primary ring-offset-background focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                                            {{ isset($order) && ($order->payment_method ?? '') === 'mercadopago' ? 'checked' : '' }}>
                                        <label for="payment_mercadopago"
                                            class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex-1 cursor-pointer">
                            ...
                            <div class="p-6 pt-0 space-y-4">
                                ...
                                <div class="space-y-2">
                                    <div class="flex justify-between text-sm">
                                        ...
                                        <span id="summarySubtotal" class="font-semibold">R$
                                            {{ number_format($cartData['subtotal'] ?? 0, 2, ',', '.') }}</span>
                                    </div>


                                    <!-- Linha de Cupom (oculta por padrão) -->
                                    <div id="summaryCouponRow" class="flex justify-between text-sm hidden">
                                        <span id="summaryCouponLabel" class="text-muted-foreground">Cupom</span>
                                        <span id="summaryCoupon" class="font-semibold text-green-600">- R$ 0,00</span>
                                    </div>

                                    <div class="flex justify-between text-sm">
                                        <span class="text-muted-foreground">Entrega</span>
                                        <div class="text-right">
                                            <!-- Valor original (riscado se tiver desconto) -->
                                            <span id="summaryDeliveryFeeOriginal"
                                                class="text-xs text-muted-foreground line-through mr-1 hidden"></span>
                                    ...
                                    <!-- Linha de Desconto no Frete (oculta por padrão) -->
                                    <div id="summaryDeliveryDiscountRow" class="flex justify-between text-sm hidden">
                                        <span id="summaryDeliveryDiscountLabel"
                                            class="text-muted-foreground text-xs">Desconto entrega</span>
                                        <span id="summaryDeliveryDiscount" class="font-semibold text-green-600 text-xs">- R$
                                            0,00</span>
                                    </div>
                                    ...
                                    <!-- Linha de Cashback Ganho (oculta por padrão) -->
                                    <div id="summaryCashbackEarned" class="flex justify-end text-xs hidden mt-1">
                                        <span id="summaryCashbackEarnedValue" class="text-purple-600 font-medium">Você ganhará R$ 0,00 de cashback</span>
                                    </div>
                                </div>
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span id="summaryTotal" class="text-2xl font-bold text-primary">R$
                                        {{ number_format($cartData['subtotal'] ?? 0, 2, ',', '.') }}</span>
                                </div>

                                <button type="submit"
                                    class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-11 rounded-md px-8 w-full shadow-warm">
                                    Confirmar Pedido
                                </button>

                                <p class="text-xs text-center text-muted-foreground">Ao confirmar, você concorda com nossos
                                    termos de serviço</p>
                            </div>
                        </div>
                    </div>
