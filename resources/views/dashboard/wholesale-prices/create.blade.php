...
@section('title', 'Novo Preço de Revenda - OLIKA Dashboard')
...
<div class="space-y-6 animate-in fade-in duration-500">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-3xl font-bold tracking-tight">Novo Preço de Revenda</h1>
                <p class="text-muted-foreground">Cadastre um preço diferenciado para clientes de revenda</p>
            </div>
        </div>
    </div>
