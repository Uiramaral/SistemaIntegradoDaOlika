...
@section('title', 'Novo Cliente - OLIKA Dashboard')
...
<div class="space-y-6 animate-in fade-in duration-500">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-3xl font-bold tracking-tight">Novo Cliente</h1>
                <p class="text-muted-foreground">Cadastre um novo cliente no sistema</p>
            </div>
        </div>
</div>
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <div class="space-y-2">
                            <input 
                                ...
                                step="0.01"
                                min="0"
                                value="{{ old('cashback_balance', '0.00') }}" 
                                class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                                placeholder="0.00"
                            >
                            <p class="text-xs text-muted-foreground">Defina o valor inicial de cashback que o cliente deve ter. O sistema criará automaticamente uma transação de crédito.</p>
                        </div>
