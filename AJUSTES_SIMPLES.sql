-- ============================================
-- AJUSTES SIMPLIFICADOS - EXECUTE UM POR VEZ
-- ============================================
...
-- 9. Adicionar address_id em orders (IGNORE SE JÁ EXISTIR)
...
-- 12. Criar tabela whatsapp_settings
...
-- 13. Criar tabela whatsapp_templates
...
-- 14. Criar tabela order_statuses
...
-- 15. Criar tabela order_status_history
