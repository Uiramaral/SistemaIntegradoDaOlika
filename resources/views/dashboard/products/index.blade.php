...
@section('content')
    <div class="bg-card rounded-xl border border-border animate-fade-in" id="products-page"
                ...
                <div class="product-card border border-border rounded-xl p-4 hover:shadow-md transition-all overflow-hidden"
                    ...
                    <div class="flex items-start justify-between mb-2">
                        ...
                        <div class="flex items-center gap-0.5 flex-shrink-0">
                            ...
                            <form action="{{ route('dashboard.products.destroy', $product->id) }}" method="POST" class="inline"
                    ...
                    <div class="pt-2 border-t border-border">
                        ...
                        <div class="hidden lg:flex items-center justify-between">
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-xs font-medium {{ $stock < 50 ? 'text-red-600' : 'text-foreground' }} mt-0.5">
                                    {{ $stock }} un</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-stretch gap-2 lg:hidden">
                            ...
                            <div class="min-w-0 flex-1 overflow-hidden">
                                ...
                                <p
                                    class="text-sm font-medium {{ $stock < 50 ? 'text-red-600' : 'text-foreground' }} truncate mt-0.5">
                                    {{ $stock }} un</p>
                            </div>
                            <span class="text-muted-foreground/40 self-center shrink-0 text-sm">·</span>
                            <div class="min-w-0 flex-1 overflow-hidden text-right">
                                ...
                                <p
                                    class="text-xs font-medium {{ $isActive ? 'text-green-600' : 'text-muted-foreground' }} truncate mt-0.5">
                                    {{ $isActive ? 'Ativo' : 'Inativo' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
